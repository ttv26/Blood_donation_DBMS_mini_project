      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_gender']; ?></td>
                    ...
                    <a style="background-color:yellow" href='update.php?
                    id=<?php echo $row['donor_id']; ?>&
                    dname=<?php echo $row['donor_name']; ?>&
                    dnumber=<?php echo $row['donor_number']; ?>&
                    dmail=<?php echo $row['donor_mail']; ?>&
                    dage=<?php echo $row['donor_age']; ?>&
                    dgender=<?php echo $row['donor_gender']; ?>&
                    dgroup=<?php echo $row['blood_group']; ?>&
                     id=<?php echo $row['donor_id']; ?>&
                    daddress=<?php echo $row['donor_address']; ?>
